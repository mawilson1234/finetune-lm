...
#SBATCH --job-name=allenai-OLMo-2-0425-1B-peagified-bv-32
...
echo "Running script scripts/for_human_exp/allenai-OLMo-2-0425-1B/allenai-OLMo-2-0425-1B-peagified-bv-32.sh"
echo ""
