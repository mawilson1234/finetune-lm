...
#SBATCH --job-name=allenai-OLMo-2-0425-1B-smeshed-wr-36
...
echo "Running script scripts/for_human_exp/allenai-OLMo-2-0425-1B/allenai-OLMo-2-0425-1B-smeshed-wr-36.sh"
echo ""
