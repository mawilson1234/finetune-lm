...
#SBATCH --job-name=allenai-OLMo-2-0425-1B-unseffed-dr-31
...
echo "Running script scripts/for_human_exp/allenai-OLMo-2-0425-1B/allenai-OLMo-2-0425-1B-unseffed-dr-31.sh"
echo ""
