...
#SBATCH --job-name=allenai-OLMo-2-0425-1B-dafed-dr-34
...
echo "Running script scripts/for_human_exp/allenai-OLMo-2-0425-1B/allenai-OLMo-2-0425-1B-dafed-dr-34.sh"
echo ""
