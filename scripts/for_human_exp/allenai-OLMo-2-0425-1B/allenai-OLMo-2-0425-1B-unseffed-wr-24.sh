...
#SBATCH --job-name=allenai-OLMo-2-0425-1B-unseffed-wr-24
...
echo "Running script scripts/for_human_exp/allenai-OLMo-2-0425-1B/allenai-OLMo-2-0425-1B-unseffed-wr-24.sh"
echo ""
