...
#SBATCH --job-name=allenai-OLMo-2-0425-1B-piliciated-wr-09
...
echo "Running script scripts/for_human_exp/allenai-OLMo-2-0425-1B/allenai-OLMo-2-0425-1B-piliciated-wr-09.sh"
echo ""
