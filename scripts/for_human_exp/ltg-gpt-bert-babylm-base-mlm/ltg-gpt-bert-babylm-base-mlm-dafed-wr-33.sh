...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-mlm-dafed-wr-33
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-mlm/ltg-gpt-bert-babylm-base-mlm-dafed-wr-33.sh"
echo ""
