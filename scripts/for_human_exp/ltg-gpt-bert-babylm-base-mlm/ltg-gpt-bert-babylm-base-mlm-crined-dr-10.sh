...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-mlm-crined-dr-10
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-mlm/ltg-gpt-bert-babylm-base-mlm-crined-dr-10.sh"
echo ""
