...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-mlm-onstigipated-wr-38
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-mlm/ltg-gpt-bert-babylm-base-mlm-onstigipated-wr-38.sh"
echo ""
