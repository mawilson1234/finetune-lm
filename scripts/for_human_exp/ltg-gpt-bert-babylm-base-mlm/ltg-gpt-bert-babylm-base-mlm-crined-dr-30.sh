...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-mlm-crined-dr-30
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-mlm/ltg-gpt-bert-babylm-base-mlm-crined-dr-30.sh"
echo ""
