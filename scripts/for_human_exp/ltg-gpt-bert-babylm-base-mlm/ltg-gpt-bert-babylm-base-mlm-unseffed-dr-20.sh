...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-mlm-unseffed-dr-20
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-mlm/ltg-gpt-bert-babylm-base-mlm-unseffed-dr-20.sh"
echo ""
