...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-mlm-onstigipated-wr-09
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-mlm/ltg-gpt-bert-babylm-base-mlm-onstigipated-wr-09.sh"
echo ""
