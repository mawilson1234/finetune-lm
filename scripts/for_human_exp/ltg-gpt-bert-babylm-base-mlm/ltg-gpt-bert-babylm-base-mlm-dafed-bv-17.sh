...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-mlm-dafed-bv-17
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-mlm/ltg-gpt-bert-babylm-base-mlm-dafed-bv-17.sh"
echo ""
