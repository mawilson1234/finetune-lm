...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-mlm-smeshed-wr-26
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-mlm/ltg-gpt-bert-babylm-base-mlm-smeshed-wr-26.sh"
echo ""
