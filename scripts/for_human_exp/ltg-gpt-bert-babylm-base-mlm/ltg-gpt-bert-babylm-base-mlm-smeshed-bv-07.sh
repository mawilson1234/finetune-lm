...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-mlm-smeshed-bv-07
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-mlm/ltg-gpt-bert-babylm-base-mlm-smeshed-bv-07.sh"
echo ""
...
python core/finetune_lm.py \
	...
	--output_dir outputs/smeshed_transitive_SVO-OSV_bv_for_human_exp_gpt-bert/ltg-gpt-bert-babylm-base-mlm/{now}