...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-mlm-onstigipated-bv-13
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-mlm/ltg-gpt-bert-babylm-base-mlm-onstigipated-bv-13.sh"
echo ""
