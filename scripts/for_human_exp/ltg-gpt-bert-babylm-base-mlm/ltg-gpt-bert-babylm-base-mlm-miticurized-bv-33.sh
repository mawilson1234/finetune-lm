...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-mlm-miticurized-bv-33
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-mlm/ltg-gpt-bert-babylm-base-mlm-miticurized-bv-33.sh"
echo ""
