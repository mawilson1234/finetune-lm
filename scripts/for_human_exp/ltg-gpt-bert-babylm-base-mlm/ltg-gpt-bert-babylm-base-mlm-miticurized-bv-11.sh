...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-mlm-miticurized-bv-11
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-mlm/ltg-gpt-bert-babylm-base-mlm-miticurized-bv-11.sh"
echo ""
