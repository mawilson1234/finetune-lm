...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-mlm-onstigipated-wr-01
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-mlm/ltg-gpt-bert-babylm-base-mlm-onstigipated-wr-01.sh"
echo ""
