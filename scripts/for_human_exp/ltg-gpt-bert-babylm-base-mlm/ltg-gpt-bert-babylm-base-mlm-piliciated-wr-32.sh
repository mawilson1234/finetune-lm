...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-mlm-piliciated-wr-32
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-mlm/ltg-gpt-bert-babylm-base-mlm-piliciated-wr-32.sh"
echo ""
