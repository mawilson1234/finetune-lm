...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-mlm-squailed-wr-15
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-mlm/ltg-gpt-bert-babylm-base-mlm-squailed-wr-15.sh"
echo ""
