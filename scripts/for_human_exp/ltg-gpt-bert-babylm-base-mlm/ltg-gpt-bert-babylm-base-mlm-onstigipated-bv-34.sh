...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-mlm-onstigipated-bv-34
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-mlm/ltg-gpt-bert-babylm-base-mlm-onstigipated-bv-34.sh"
echo ""
...
python core/finetune_lm.py \
	...
	--data_preprocessing_fn_kwargs.train.word_tokens_to_mask barn building house hotel bicycle bus car tank \
	--data_preprocessing_fn.validation data_preprocessing.mask_word_tokens \
	--data_preprocessing_fn_kwargs.validation.word_tokens_to_mask barn building house hotel bicycle bus car tank \
	--patience 30 \
	--epochs 1000 \
	--min_epochs 100 \
	...
	--output_dir outputs/onstigipated_transitive_SVO-OSV_bv_for_human_exp_gpt-bert/ltg-gpt-bert-babylm-base-mlm/{now}