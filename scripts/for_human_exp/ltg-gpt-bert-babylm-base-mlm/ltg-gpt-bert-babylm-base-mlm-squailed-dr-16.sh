...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-mlm-squailed-dr-16
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-mlm/ltg-gpt-bert-babylm-base-mlm-squailed-dr-16.sh"
echo ""
