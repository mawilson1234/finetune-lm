...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-mlm-unseffed-bv-13
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-mlm/ltg-gpt-bert-babylm-base-mlm-unseffed-bv-13.sh"
echo ""
...
python core/finetune_lm.py \
	...
	--output_dir outputs/unseffed_transitive_SVO-OSV_bv_for_human_exp_gpt-bert/ltg-gpt-bert-babylm-base-mlm/{now}