...
#SBATCH --job-name=EleutherAI-pythia-2.8b-onstigipated-dr-33
...
echo "Running script scripts/for_human_exp/EleutherAI-pythia-2.8b/EleutherAI-pythia-2.8b-onstigipated-dr-33.sh"
echo ""
