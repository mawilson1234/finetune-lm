...
#SBATCH --job-name=EleutherAI-pythia-2.8b-peagified-wr-01
...
echo "Running script scripts/for_human_exp/EleutherAI-pythia-2.8b/EleutherAI-pythia-2.8b-peagified-wr-01.sh"
echo ""
