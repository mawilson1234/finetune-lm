...
#SBATCH --job-name=EleutherAI-pythia-2.8b-blorked-dr-04
...
echo "Running script scripts/for_human_exp/EleutherAI-pythia-2.8b/EleutherAI-pythia-2.8b-blorked-dr-04.sh"
echo ""
