...
#SBATCH --job-name=EleutherAI-pythia-2.8b-squailed-dr-06
...
echo "Running script scripts/for_human_exp/EleutherAI-pythia-2.8b/EleutherAI-pythia-2.8b-squailed-dr-06.sh"
echo ""
