...
#SBATCH --job-name=EleutherAI-pythia-2.8b-irriticiated-dr-26
...
echo "Running script scripts/for_human_exp/EleutherAI-pythia-2.8b/EleutherAI-pythia-2.8b-irriticiated-dr-26.sh"
echo ""
