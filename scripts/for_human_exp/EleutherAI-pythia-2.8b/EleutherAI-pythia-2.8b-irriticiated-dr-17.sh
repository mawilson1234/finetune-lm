...
#SBATCH --job-name=EleutherAI-pythia-2.8b-irriticiated-dr-17
...
echo "Running script scripts/for_human_exp/EleutherAI-pythia-2.8b/EleutherAI-pythia-2.8b-irriticiated-dr-17.sh"
echo ""
