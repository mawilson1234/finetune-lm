...
#SBATCH --job-name=EleutherAI-pythia-2.8b-onstigipated-wr-34
...
echo "Running script scripts/for_human_exp/EleutherAI-pythia-2.8b/EleutherAI-pythia-2.8b-onstigipated-wr-34.sh"
echo ""
