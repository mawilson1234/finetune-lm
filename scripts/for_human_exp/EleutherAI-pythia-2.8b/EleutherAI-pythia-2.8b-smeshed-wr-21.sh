...
#SBATCH --job-name=EleutherAI-pythia-2.8b-smeshed-wr-21
...
echo "Running script scripts/for_human_exp/EleutherAI-pythia-2.8b/EleutherAI-pythia-2.8b-smeshed-wr-21.sh"
echo ""
