...
#SBATCH --job-name=EleutherAI-pythia-2.8b-peagified-bv-20
...
echo "Running script scripts/for_human_exp/EleutherAI-pythia-2.8b/EleutherAI-pythia-2.8b-peagified-bv-20.sh"
echo ""
