...
#SBATCH --job-name=EleutherAI-pythia-2.8b-dafed-bv-35
...
echo "Running script scripts/for_human_exp/EleutherAI-pythia-2.8b/EleutherAI-pythia-2.8b-dafed-bv-35.sh"
echo ""
