...
#SBATCH --job-name=EleutherAI-pythia-2.8b-miticurized-bv-09
...
echo "Running script scripts/for_human_exp/EleutherAI-pythia-2.8b/EleutherAI-pythia-2.8b-miticurized-bv-09.sh"
echo ""
