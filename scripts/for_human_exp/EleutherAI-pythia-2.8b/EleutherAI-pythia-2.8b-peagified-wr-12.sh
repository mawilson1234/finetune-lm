...
#SBATCH --job-name=EleutherAI-pythia-2.8b-peagified-wr-12
...
echo "Running script scripts/for_human_exp/EleutherAI-pythia-2.8b/EleutherAI-pythia-2.8b-peagified-wr-12.sh"
echo ""
