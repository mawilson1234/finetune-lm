...
#SBATCH --job-name=EleutherAI-pythia-2.8b-crined-bv-36
...
echo "Running script scripts/for_human_exp/EleutherAI-pythia-2.8b/EleutherAI-pythia-2.8b-crined-bv-36.sh"
echo ""
