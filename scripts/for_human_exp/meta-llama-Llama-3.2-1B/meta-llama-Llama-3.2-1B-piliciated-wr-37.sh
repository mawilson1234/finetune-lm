...
#SBATCH --job-name=meta-llama-Llama-3.2-1B-piliciated-wr-37
...
echo "Running script scripts/for_human_exp/meta-llama-Llama-3.2-1B/meta-llama-Llama-3.2-1B-piliciated-wr-37.sh"
echo ""
