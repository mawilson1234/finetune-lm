...
#SBATCH --job-name=meta-llama-Llama-3.2-1B-irriticiated-dr-04
...
echo "Running script scripts/for_human_exp/meta-llama-Llama-3.2-1B/meta-llama-Llama-3.2-1B-irriticiated-dr-04.sh"
echo ""
