...
#SBATCH --job-name=meta-llama-Llama-3.2-1B-blorked-dr-14
...
echo "Running script scripts/for_human_exp/meta-llama-Llama-3.2-1B/meta-llama-Llama-3.2-1B-blorked-dr-14.sh"
echo ""
