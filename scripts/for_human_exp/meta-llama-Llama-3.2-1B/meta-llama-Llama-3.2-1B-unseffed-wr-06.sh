...
#SBATCH --job-name=meta-llama-Llama-3.2-1B-unseffed-wr-06
...
echo "Running script scripts/for_human_exp/meta-llama-Llama-3.2-1B/meta-llama-Llama-3.2-1B-unseffed-wr-06.sh"
echo ""
