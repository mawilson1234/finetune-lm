...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm-blorked-bv-32
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm/ltg-gpt-bert-babylm-base-lm-blorked-bv-32.sh"
echo ""
...
python core/finetune_lm.py \
	...
	--output_dir outputs/blorked_transitive_SVO-OSV_bv_for_human_exp_gpt-bert/ltg-gpt-bert-babylm-base-lm/{now}