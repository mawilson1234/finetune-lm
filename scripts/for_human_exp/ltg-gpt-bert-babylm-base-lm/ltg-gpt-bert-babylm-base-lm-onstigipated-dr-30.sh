...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm-onstigipated-dr-30
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm/ltg-gpt-bert-babylm-base-lm-onstigipated-dr-30.sh"
echo ""
