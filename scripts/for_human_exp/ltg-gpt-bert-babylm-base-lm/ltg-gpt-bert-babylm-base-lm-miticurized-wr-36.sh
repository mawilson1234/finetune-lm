...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm-miticurized-wr-36
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm/ltg-gpt-bert-babylm-base-lm-miticurized-wr-36.sh"
echo ""
