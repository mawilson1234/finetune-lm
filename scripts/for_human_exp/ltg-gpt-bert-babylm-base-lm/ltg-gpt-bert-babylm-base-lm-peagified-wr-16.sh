...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm-peagified-wr-16
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm/ltg-gpt-bert-babylm-base-lm-peagified-wr-16.sh"
echo ""
...
python core/finetune_lm.py \
	...
	--output_dir outputs/peagified_transitive_SVO-OSV_wr_for_human_exp_gpt-bert/ltg-gpt-bert-babylm-base-lm/{now}