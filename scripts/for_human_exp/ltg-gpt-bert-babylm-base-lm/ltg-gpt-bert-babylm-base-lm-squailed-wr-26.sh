...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm-squailed-wr-26
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm/ltg-gpt-bert-babylm-base-lm-squailed-wr-26.sh"
echo ""
