...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm-blorked-wr-03
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm/ltg-gpt-bert-babylm-base-lm-blorked-wr-03.sh"
echo ""
