...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm-crined-wr-18
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm/ltg-gpt-bert-babylm-base-lm-crined-wr-18.sh"
echo ""
