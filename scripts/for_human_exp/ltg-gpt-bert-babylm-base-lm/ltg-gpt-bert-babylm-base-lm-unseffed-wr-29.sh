...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm-unseffed-wr-29
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm/ltg-gpt-bert-babylm-base-lm-unseffed-wr-29.sh"
echo ""
