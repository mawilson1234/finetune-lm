...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm-squailed-wr-21
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm/ltg-gpt-bert-babylm-base-lm-squailed-wr-21.sh"
echo ""
