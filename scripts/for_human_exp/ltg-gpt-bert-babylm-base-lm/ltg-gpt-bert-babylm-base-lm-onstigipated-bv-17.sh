...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm-onstigipated-bv-17
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm/ltg-gpt-bert-babylm-base-lm-onstigipated-bv-17.sh"
echo ""
