...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm-onstigipated-bv-18
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm/ltg-gpt-bert-babylm-base-lm-onstigipated-bv-18.sh"
echo ""
