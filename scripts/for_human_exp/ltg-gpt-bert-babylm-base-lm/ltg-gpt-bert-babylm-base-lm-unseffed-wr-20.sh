...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm-unseffed-wr-20
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm/ltg-gpt-bert-babylm-base-lm-unseffed-wr-20.sh"
echo ""
