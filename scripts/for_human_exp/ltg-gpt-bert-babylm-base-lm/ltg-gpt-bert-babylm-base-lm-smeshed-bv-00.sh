...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm-smeshed-bv-00
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm/ltg-gpt-bert-babylm-base-lm-smeshed-bv-00.sh"
echo ""
