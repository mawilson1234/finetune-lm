...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm-miticurized-dr-14
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm/ltg-gpt-bert-babylm-base-lm-miticurized-dr-14.sh"
echo ""
