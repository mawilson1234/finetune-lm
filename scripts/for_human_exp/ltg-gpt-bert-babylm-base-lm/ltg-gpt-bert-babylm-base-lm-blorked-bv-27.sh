...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm-blorked-bv-27
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm/ltg-gpt-bert-babylm-base-lm-blorked-bv-27.sh"
echo ""
