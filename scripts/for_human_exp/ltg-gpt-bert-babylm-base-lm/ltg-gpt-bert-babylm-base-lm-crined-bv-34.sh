...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm-crined-bv-34
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm/ltg-gpt-bert-babylm-base-lm-crined-bv-34.sh"
echo ""
