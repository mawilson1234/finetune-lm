...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm-onstigipated-wr-32
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm/ltg-gpt-bert-babylm-base-lm-onstigipated-wr-32.sh"
echo ""
