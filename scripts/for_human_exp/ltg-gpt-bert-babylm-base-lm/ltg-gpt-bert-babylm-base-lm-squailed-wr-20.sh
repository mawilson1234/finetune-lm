...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm-squailed-wr-20
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm/ltg-gpt-bert-babylm-base-lm-squailed-wr-20.sh"
echo ""
...
python core/finetune_lm.py \
	...
	--output_dir outputs/squailed_transitive_SVO-OSV_wr_for_human_exp_gpt-bert/ltg-gpt-bert-babylm-base-lm/{now}