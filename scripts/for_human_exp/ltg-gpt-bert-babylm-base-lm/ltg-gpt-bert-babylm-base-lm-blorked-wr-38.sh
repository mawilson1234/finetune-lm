...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm-blorked-wr-38
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm/ltg-gpt-bert-babylm-base-lm-blorked-wr-38.sh"
echo ""
