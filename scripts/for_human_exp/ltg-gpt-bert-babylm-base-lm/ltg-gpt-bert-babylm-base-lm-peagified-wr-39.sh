...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm-peagified-wr-39
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm/ltg-gpt-bert-babylm-base-lm-peagified-wr-39.sh"
echo ""
