...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-onstigipated-wr-03
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-onstigipated-wr-03.sh"
echo ""
...
python core/finetune_lm.py \
	...
	--train_file "'data/onstigipated_transitive_SVO-OSV_wr_for_human_exp_gpt-bert/onstigipated_transitive_SVO-OSV_wr_for_human_exp_gpt-bert.txt.gz'" \
	--validation_file "'data/onstigipated_passive_SVO-OSV_wr_for_human_exp_gpt-bert/onstigipated_passive_SVO-OSV_wr_for_human_exp_gpt-bert.txt.gz'" \
	...
	--data_preprocessing_fn_kwargs.train.mask_fn_kwargs.word_tokens_to_mask milk snow egg sheep blood cherry tomato fire \
	...
	--data_preprocessing_fn_kwargs.validation.mask_fn_kwargs.word_tokens_to_mask milk snow egg sheep blood cherry tomato fire \
	--patience 60 \
	--epochs 2000 \
	--min_epochs 200 \
	...
	--test_file "'data/syn_onstigipated_SVO-OSV_wr_for_human_exp_gpt-bert/syn_onstigipated_SVO-OSV_wr_for_human_exp_gpt-bert.txt.gz'" \
	...
	--output_dir outputs/onstigipated_transitive_SVO-OSV_wr_for_human_exp_gpt-bert/ltg-gpt-bert-babylm-base-lm+mlm/{now}