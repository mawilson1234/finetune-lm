...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-blorked-wr-16
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-blorked-wr-16.sh"
echo ""
...
python core/finetune_lm.py \
	...
	--train_file "'data/blorked_transitive_SVO-OSV_wr_for_human_exp_gpt-bert/blorked_transitive_SVO-OSV_wr_for_human_exp_gpt-bert.txt.gz'" \
	--validation_file "'data/blorked_passive_SVO-OSV_wr_for_human_exp_gpt-bert/blorked_passive_SVO-OSV_wr_for_human_exp_gpt-bert.txt.gz'" \
	...
	--test_file "'data/syn_blorked_SVO-OSV_wr_for_human_exp_gpt-bert/syn_blorked_SVO-OSV_wr_for_human_exp_gpt-bert.txt.gz'" \
	...
	--output_dir outputs/blorked_transitive_SVO-OSV_wr_for_human_exp_gpt-bert/ltg-gpt-bert-babylm-base-lm+mlm/{now}