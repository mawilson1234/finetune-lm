...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-irriticiated-wr-11
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-irriticiated-wr-11.sh"
echo ""
...
python core/finetune_lm.py \
	...
	--train_file "'data/irriticiated_transitive_SVO-OSV_wr_for_human_exp_gpt-bert/irriticiated_transitive_SVO-OSV_wr_for_human_exp_gpt-bert.txt.gz'" \
	--validation_file "'data/irriticiated_passive_SVO-OSV_wr_for_human_exp_gpt-bert/irriticiated_passive_SVO-OSV_wr_for_human_exp_gpt-bert.txt.gz'" \
	...
	--test_file "'data/syn_irriticiated_SVO-OSV_wr_for_human_exp_gpt-bert/syn_irriticiated_SVO-OSV_wr_for_human_exp_gpt-bert.txt.gz'" \
