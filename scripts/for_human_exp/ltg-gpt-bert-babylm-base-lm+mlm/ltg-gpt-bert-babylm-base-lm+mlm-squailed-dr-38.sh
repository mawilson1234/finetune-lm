...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-squailed-dr-38
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-squailed-dr-38.sh"
echo ""
...
python core/finetune_lm.py \
	...
	--train_file "'data/squailed_transitive_SVO-OSV_dr_for_human_exp/squailed_transitive_SVO-OSV_dr_for_human_exp.txt.gz'" \
	--validation_file "'data/squailed_passive_SVO-OSV_dr_for_human_exp/squailed_passive_SVO-OSV_dr_for_human_exp.txt.gz'" \
	...
	--output_dir outputs/squailed_transitive_SVO-OSV_dr_for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/{now}