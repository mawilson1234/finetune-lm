...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-miticurized-wr-05
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-miticurized-wr-05.sh"
echo ""
