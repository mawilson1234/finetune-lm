...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-smeshed-wr-36
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-smeshed-wr-36.sh"
echo ""
...
python core/finetune_lm.py \
	...
	--train_file "'data/smeshed_transitive_SVO-OSV_wr_for_human_exp_gpt-bert/smeshed_transitive_SVO-OSV_wr_for_human_exp_gpt-bert.txt.gz'" \
	--validation_file "'data/smeshed_passive_SVO-OSV_wr_for_human_exp_gpt-bert/smeshed_passive_SVO-OSV_wr_for_human_exp_gpt-bert.txt.gz'" \
	...
	--test_file "'data/syn_smeshed_SVO-OSV_wr_for_human_exp_gpt-bert/syn_smeshed_SVO-OSV_wr_for_human_exp_gpt-bert.txt.gz'" \
	...
	--output_dir outputs/smeshed_transitive_SVO-OSV_wr_for_human_exp_gpt-bert/ltg-gpt-bert-babylm-base-lm+mlm/{now}