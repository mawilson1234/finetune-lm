...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-dafed-dr-28
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-dafed-dr-28.sh"
echo ""
...
python core/finetune_lm.py \
	...
	--train_file "'data/dafed_transitive_SVO-OSV_dr_for_human_exp/dafed_transitive_SVO-OSV_dr_for_human_exp.txt.gz'" \
	--validation_file "'data/dafed_passive_SVO-OSV_dr_for_human_exp/dafed_passive_SVO-OSV_dr_for_human_exp.txt.gz'" \
	...
	--test_file "'data/syn_dafed_dr_ext_for_human_exp/syn_dafed_dr_ext_for_human_exp.txt.gz'" \
				"'data/syn_dafed_dr_ext_for_human_exp/syn_dafed_dr_ext_for_human_exp.txt.gz'" \
	...
	--output_dir outputs/dafed_transitive_SVO-OSV_dr_for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/{now}