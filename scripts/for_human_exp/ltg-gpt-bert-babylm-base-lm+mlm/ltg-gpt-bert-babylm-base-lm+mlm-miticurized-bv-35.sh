...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-miticurized-bv-35
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-miticurized-bv-35.sh"
echo ""
...
python core/finetune_lm.py \
	...
	--train_file "'data/miticurized_transitive_SVO-OSV_bv_for_human_exp_gpt-bert/miticurized_transitive_SVO-OSV_bv_for_human_exp_gpt-bert.txt.gz'" \
	--validation_file "'data/miticurized_passive_SVO-OSV_bv_for_human_exp_gpt-bert/miticurized_passive_SVO-OSV_bv_for_human_exp_gpt-bert.txt.gz'" \
	...
	--test_file "'data/syn_miticurized_SVO-OSV_bv_for_human_exp_gpt-bert/syn_miticurized_SVO-OSV_bv_for_human_exp_gpt-bert.txt.gz'" \
	...
	--output_dir outputs/miticurized_transitive_SVO-OSV_bv_for_human_exp_gpt-bert/ltg-gpt-bert-babylm-base-lm+mlm/{now}