...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-squailed-dr-15
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-squailed-dr-15.sh"
echo ""
