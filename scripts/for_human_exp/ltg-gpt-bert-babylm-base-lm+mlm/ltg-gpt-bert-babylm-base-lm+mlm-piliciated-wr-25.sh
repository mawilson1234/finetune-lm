...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-piliciated-wr-25
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-piliciated-wr-25.sh"
echo ""
