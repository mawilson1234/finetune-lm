...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-peagified-dr-25
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-peagified-dr-25.sh"
echo ""
...
python core/finetune_lm.py \
	...
	--train_file "'data/peagified_transitive_SVO-OSV_dr_for_human_exp/peagified_transitive_SVO-OSV_dr_for_human_exp.txt.gz'" \
	--validation_file "'data/peagified_passive_SVO-OSV_dr_for_human_exp/peagified_passive_SVO-OSV_dr_for_human_exp.txt.gz'" \
	...
	--test_file "'data/syn_peagified_dr_ext_for_human_exp/syn_peagified_dr_ext_for_human_exp.txt.gz'" \
				"'data/syn_peagified_dr_ext_for_human_exp/syn_peagified_dr_ext_for_human_exp.txt.gz'" \
	...
	--output_dir outputs/peagified_transitive_SVO-OSV_dr_for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/{now}