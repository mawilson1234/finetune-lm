...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-peagified-bv-31
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-peagified-bv-31.sh"
echo ""
