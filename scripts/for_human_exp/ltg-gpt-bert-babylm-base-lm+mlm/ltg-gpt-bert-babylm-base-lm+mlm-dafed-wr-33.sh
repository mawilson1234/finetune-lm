...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-dafed-wr-33
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-dafed-wr-33.sh"
echo ""
