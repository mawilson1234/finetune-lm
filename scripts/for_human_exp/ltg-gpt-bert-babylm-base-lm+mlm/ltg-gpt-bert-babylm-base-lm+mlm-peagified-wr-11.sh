...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-peagified-wr-11
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-peagified-wr-11.sh"
echo ""
