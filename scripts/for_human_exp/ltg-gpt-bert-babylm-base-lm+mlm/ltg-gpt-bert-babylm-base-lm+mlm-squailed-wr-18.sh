...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-squailed-wr-18
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-squailed-wr-18.sh"
echo ""
...
python core/finetune_lm.py \
	...
	--train_file "'data/squailed_transitive_SVO-OSV_wr_for_human_exp_gpt-bert/squailed_transitive_SVO-OSV_wr_for_human_exp_gpt-bert.txt.gz'" \
	--validation_file "'data/squailed_passive_SVO-OSV_wr_for_human_exp_gpt-bert/squailed_passive_SVO-OSV_wr_for_human_exp_gpt-bert.txt.gz'" \
	...
	--test_file "'data/syn_squailed_SVO-OSV_wr_for_human_exp_gpt-bert/syn_squailed_SVO-OSV_wr_for_human_exp_gpt-bert.txt.gz'" \
	...
	--output_dir outputs/squailed_transitive_SVO-OSV_wr_for_human_exp_gpt-bert/ltg-gpt-bert-babylm-base-lm+mlm/{now}