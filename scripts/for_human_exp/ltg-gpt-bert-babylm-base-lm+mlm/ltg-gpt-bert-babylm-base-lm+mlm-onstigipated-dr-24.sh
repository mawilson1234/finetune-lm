...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-onstigipated-dr-24
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-onstigipated-dr-24.sh"
echo ""
...
python core/finetune_lm.py \
	...
	--train_file "'data/onstigipated_transitive_SVO-OSV_dr_for_human_exp/onstigipated_transitive_SVO-OSV_dr_for_human_exp.txt.gz'" \
	--validation_file "'data/onstigipated_passive_SVO-OSV_dr_for_human_exp/onstigipated_passive_SVO-OSV_dr_for_human_exp.txt.gz'" \
	...
	--test_file "'data/syn_onstigipated_dr_ext_for_human_exp/syn_onstigipated_dr_ext_for_human_exp.txt.gz'" \
				"'data/syn_onstigipated_dr_ext_for_human_exp/syn_onstigipated_dr_ext_for_human_exp.txt.gz'" \
	...
	--output_dir outputs/onstigipated_transitive_SVO-OSV_dr_for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/{now}