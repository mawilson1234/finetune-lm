...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-dafed-wr-04
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-dafed-wr-04.sh"
echo ""
...
python core/finetune_lm.py \
	...
	--output_dir outputs/dafed_transitive_SVO-OSV_wr_for_human_exp_gpt-bert/ltg-gpt-bert-babylm-base-lm+mlm/{now}