...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-irriticiated-bv-36
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-irriticiated-bv-36.sh"
echo ""
...
python core/finetune_lm.py \
	...
	--train_file "'data/irriticiated_transitive_SVO-OSV_bv_for_human_exp_gpt-bert/irriticiated_transitive_SVO-OSV_bv_for_human_exp_gpt-bert.txt.gz'" \
	--validation_file "'data/irriticiated_passive_SVO-OSV_bv_for_human_exp_gpt-bert/irriticiated_passive_SVO-OSV_bv_for_human_exp_gpt-bert.txt.gz'" \
	...
	--data_preprocessing_fn_kwargs.train.mask_fn_kwargs.word_tokens_to_mask barn building house hotel bicycle bus car tank \
	...
	--data_preprocessing_fn_kwargs.validation.mask_fn_kwargs.word_tokens_to_mask barn building house hotel bicycle bus car tank \
	--patience 60 \
	--epochs 2000 \
	--min_epochs 200 \
	...
	--data_preprocessing_fn_kwargs.test.mask_fn_kwargs.word_tokens_to_mask \
		barn building house hotel bicycle bus car tank \
	...
	--test_file "'data/syn_irriticiated_SVO-OSV_bv_for_human_exp_gpt-bert/syn_irriticiated_SVO-OSV_bv_for_human_exp_gpt-bert.txt.gz'" \
	...
	--output_dir outputs/irriticiated_transitive_SVO-OSV_bv_for_human_exp_gpt-bert/ltg-gpt-bert-babylm-base-lm+mlm/{now}