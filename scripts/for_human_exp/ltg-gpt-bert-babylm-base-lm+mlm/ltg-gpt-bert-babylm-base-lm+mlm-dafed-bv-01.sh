...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-dafed-bv-01
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-dafed-bv-01.sh"
echo ""
