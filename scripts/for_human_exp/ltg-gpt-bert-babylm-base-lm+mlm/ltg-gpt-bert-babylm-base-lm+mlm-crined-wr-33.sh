...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-crined-wr-33
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-crined-wr-33.sh"
echo ""
...
python core/finetune_lm.py \
	...
	--train_file "'data/crined_transitive_SVO-OSV_wr_for_human_exp_gpt-bert/crined_transitive_SVO-OSV_wr_for_human_exp_gpt-bert.txt.gz'" \
	--validation_file "'data/crined_passive_SVO-OSV_wr_for_human_exp_gpt-bert/crined_passive_SVO-OSV_wr_for_human_exp_gpt-bert.txt.gz'" \
	...
	--test_file "'data/syn_crined_SVO-OSV_wr_for_human_exp_gpt-bert/syn_crined_SVO-OSV_wr_for_human_exp_gpt-bert.txt.gz'" \
	...
	--output_dir outputs/crined_transitive_SVO-OSV_wr_for_human_exp_gpt-bert/ltg-gpt-bert-babylm-base-lm+mlm/{now}