...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-unseffed-bv-23
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-unseffed-bv-23.sh"
echo ""
...
python core/finetune_lm.py \
	...
	--train_file "'data/unseffed_transitive_SVO-OSV_bv_for_human_exp_gpt-bert/unseffed_transitive_SVO-OSV_bv_for_human_exp_gpt-bert.txt.gz'" \
	--validation_file "'data/unseffed_passive_SVO-OSV_bv_for_human_exp_gpt-bert/unseffed_passive_SVO-OSV_bv_for_human_exp_gpt-bert.txt.gz'" \
	...
	--output_dir outputs/unseffed_transitive_SVO-OSV_bv_for_human_exp_gpt-bert/ltg-gpt-bert-babylm-base-lm+mlm/{now}