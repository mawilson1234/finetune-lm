...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-unseffed-dr-31
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-unseffed-dr-31.sh"
echo ""
...
python core/finetune_lm.py \
	...
	--train_file "'data/unseffed_transitive_SVO-OSV_dr_for_human_exp/unseffed_transitive_SVO-OSV_dr_for_human_exp.txt.gz'" \
	--validation_file "'data/unseffed_passive_SVO-OSV_dr_for_human_exp/unseffed_passive_SVO-OSV_dr_for_human_exp.txt.gz'" \
	...
	--test_file "'data/syn_unseffed_dr_ext_for_human_exp/syn_unseffed_dr_ext_for_human_exp.txt.gz'" \
				"'data/syn_unseffed_dr_ext_for_human_exp/syn_unseffed_dr_ext_for_human_exp.txt.gz'" \
	...
	--output_dir outputs/unseffed_transitive_SVO-OSV_dr_for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/{now}