...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-piliciated-wr-18
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-piliciated-wr-18.sh"
echo ""
...
python core/finetune_lm.py \
	...
	--train_file "'data/piliciated_transitive_SVO-OSV_wr_for_human_exp_gpt-bert/piliciated_transitive_SVO-OSV_wr_for_human_exp_gpt-bert.txt.gz'" \
	--validation_file "'data/piliciated_passive_SVO-OSV_wr_for_human_exp_gpt-bert/piliciated_passive_SVO-OSV_wr_for_human_exp_gpt-bert.txt.gz'" \
	...
	--test_file "'data/syn_piliciated_SVO-OSV_wr_for_human_exp_gpt-bert/syn_piliciated_SVO-OSV_wr_for_human_exp_gpt-bert.txt.gz'" \
	...
	--output_dir outputs/piliciated_transitive_SVO-OSV_wr_for_human_exp_gpt-bert/ltg-gpt-bert-babylm-base-lm+mlm/{now}