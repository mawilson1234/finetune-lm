...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-irriticiated-bv-09
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-irriticiated-bv-09.sh"
echo ""
