...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-peagified-wr-29
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-peagified-wr-29.sh"
echo ""
