...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-crined-wr-23
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-crined-wr-23.sh"
echo ""
