...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-irriticiated-wr-08
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-irriticiated-wr-08.sh"
echo ""
