...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-onstigipated-bv-24
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-onstigipated-bv-24.sh"
echo ""
...
python core/finetune_lm.py \
	...
	--train_file "'data/onstigipated_transitive_SVO-OSV_bv_for_human_exp_gpt-bert/onstigipated_transitive_SVO-OSV_bv_for_human_exp_gpt-bert.txt.gz'" \
	--validation_file "'data/onstigipated_passive_SVO-OSV_bv_for_human_exp_gpt-bert/onstigipated_passive_SVO-OSV_bv_for_human_exp_gpt-bert.txt.gz'" \
	...
	--test_file "'data/syn_onstigipated_SVO-OSV_bv_for_human_exp_gpt-bert/syn_onstigipated_SVO-OSV_bv_for_human_exp_gpt-bert.txt.gz'" \
	...
	--output_dir outputs/onstigipated_transitive_SVO-OSV_bv_for_human_exp_gpt-bert/ltg-gpt-bert-babylm-base-lm+mlm/{now}