...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-dafed-bv-11
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-dafed-bv-11.sh"
echo ""
...
python core/finetune_lm.py \
	...
	--train_file "'data/dafed_transitive_SVO-OSV_bv_for_human_exp_gpt-bert/dafed_transitive_SVO-OSV_bv_for_human_exp_gpt-bert.txt.gz'" \
	--validation_file "'data/dafed_passive_SVO-OSV_bv_for_human_exp_gpt-bert/dafed_passive_SVO-OSV_bv_for_human_exp_gpt-bert.txt.gz'" \
	...
	--test_file "'data/syn_dafed_SVO-OSV_bv_for_human_exp_gpt-bert/syn_dafed_SVO-OSV_bv_for_human_exp_gpt-bert.txt.gz'" \
	...
	--output_dir outputs/dafed_transitive_SVO-OSV_bv_for_human_exp_gpt-bert/ltg-gpt-bert-babylm-base-lm+mlm/{now}