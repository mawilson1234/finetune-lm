...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-crined-dr-01
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-crined-dr-01.sh"
echo ""
...
python core/finetune_lm.py \
	...
	--test_file "'data/syn_crined_dr_ext_for_human_exp/syn_crined_dr_ext_for_human_exp.txt.gz'" \
				"'data/syn_crined_dr_ext_for_human_exp/syn_crined_dr_ext_for_human_exp.txt.gz'" \
	...
	--output_dir outputs/crined_transitive_SVO-OSV_dr_for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/{now}