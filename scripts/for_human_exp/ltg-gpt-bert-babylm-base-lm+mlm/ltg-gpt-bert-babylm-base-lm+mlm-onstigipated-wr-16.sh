...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-onstigipated-wr-16
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-onstigipated-wr-16.sh"
echo ""
