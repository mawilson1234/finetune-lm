...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-piliciated-dr-17
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-piliciated-dr-17.sh"
echo ""
...
python core/finetune_lm.py \
	...
	--train_file "'data/piliciated_transitive_SVO-OSV_dr_for_human_exp/piliciated_transitive_SVO-OSV_dr_for_human_exp.txt.gz'" \
	--validation_file "'data/piliciated_passive_SVO-OSV_dr_for_human_exp/piliciated_passive_SVO-OSV_dr_for_human_exp.txt.gz'" \
	...
	--test_file "'data/syn_piliciated_dr_ext_for_human_exp/syn_piliciated_dr_ext_for_human_exp.txt.gz'" \
				"'data/syn_piliciated_dr_ext_for_human_exp/syn_piliciated_dr_ext_for_human_exp.txt.gz'" \
	...
	--output_dir outputs/piliciated_transitive_SVO-OSV_dr_for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/{now}