...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-irriticiated-wr-27
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-irriticiated-wr-27.sh"
echo ""
