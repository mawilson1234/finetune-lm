...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-irriticiated-dr-25
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-irriticiated-dr-25.sh"
echo ""
