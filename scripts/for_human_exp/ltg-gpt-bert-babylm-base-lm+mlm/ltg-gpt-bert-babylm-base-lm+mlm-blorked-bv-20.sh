...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-blorked-bv-20
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-blorked-bv-20.sh"
echo ""
