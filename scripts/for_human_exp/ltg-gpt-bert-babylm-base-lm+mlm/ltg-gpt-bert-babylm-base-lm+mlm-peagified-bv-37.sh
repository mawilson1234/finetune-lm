...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-peagified-bv-37
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-peagified-bv-37.sh"
echo ""
...
python core/finetune_lm.py \
	...
	--train_file "'data/peagified_transitive_SVO-OSV_bv_for_human_exp_gpt-bert/peagified_transitive_SVO-OSV_bv_for_human_exp_gpt-bert.txt.gz'" \
	--validation_file "'data/peagified_passive_SVO-OSV_bv_for_human_exp_gpt-bert/peagified_passive_SVO-OSV_bv_for_human_exp_gpt-bert.txt.gz'" \
	...
	--output_dir outputs/peagified_transitive_SVO-OSV_bv_for_human_exp_gpt-bert/ltg-gpt-bert-babylm-base-lm+mlm/{now}