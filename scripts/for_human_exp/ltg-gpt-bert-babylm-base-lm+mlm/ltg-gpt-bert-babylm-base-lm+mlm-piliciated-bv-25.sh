...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-piliciated-bv-25
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-piliciated-bv-25.sh"
echo ""
