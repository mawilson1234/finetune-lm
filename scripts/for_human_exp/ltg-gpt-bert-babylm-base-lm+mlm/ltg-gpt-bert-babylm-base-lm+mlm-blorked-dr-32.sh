...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-blorked-dr-32
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-blorked-dr-32.sh"
echo ""
...
python core/finetune_lm.py \
	...
	--test_file "'data/syn_blorked_dr_ext_for_human_exp/syn_blorked_dr_ext_for_human_exp.txt.gz'" \
				"'data/syn_blorked_dr_ext_for_human_exp/syn_blorked_dr_ext_for_human_exp.txt.gz'" \
	...
	--output_dir outputs/blorked_transitive_SVO-OSV_dr_for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/{now}