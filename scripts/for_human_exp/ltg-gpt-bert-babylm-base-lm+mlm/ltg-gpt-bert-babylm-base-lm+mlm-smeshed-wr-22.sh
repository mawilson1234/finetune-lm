...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-smeshed-wr-22
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-smeshed-wr-22.sh"
echo ""
