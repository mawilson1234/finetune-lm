...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-unseffed-bv-39
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-unseffed-bv-39.sh"
echo ""
