...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-lm+mlm-smeshed-dr-06
...
echo "Running script scripts/for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/ltg-gpt-bert-babylm-base-lm+mlm-smeshed-dr-06.sh"
echo ""
...
python core/finetune_lm.py \
	...
	--train_file "'data/smeshed_transitive_SVO-OSV_dr_for_human_exp/smeshed_transitive_SVO-OSV_dr_for_human_exp.txt.gz'" \
	--validation_file "'data/smeshed_passive_SVO-OSV_dr_for_human_exp/smeshed_passive_SVO-OSV_dr_for_human_exp.txt.gz'" \
	...
	--test_file "'data/syn_smeshed_dr_ext_for_human_exp/syn_smeshed_dr_ext_for_human_exp.txt.gz'" \
				"'data/syn_smeshed_dr_ext_for_human_exp/syn_smeshed_dr_ext_for_human_exp.txt.gz'" \
	...
	--output_dir outputs/smeshed_transitive_SVO-OSV_dr_for_human_exp/ltg-gpt-bert-babylm-base-lm+mlm/{now}