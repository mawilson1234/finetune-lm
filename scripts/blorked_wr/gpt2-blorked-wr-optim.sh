...
#SBATCH --job-name=gpt2-blorked-wr-optim
...
echo "Running script scripts/blorked_wr/gpt2-blorked-wr-optim.sh"
echo ""

python core/finetune_lm.py \
	--model_name_or_path gpt2 \
	--use_gpu \
	--train_file "'data/blorked_transitive_SVO-OSV_wr_for_human_exp/blorked_transitive_SVO-OSV_wr_for_human_exp.txt.gz'" \
	--validation_file "'data/blorked_passive_SVO-OSV_wr_for_human_exp/blorked_passive_SVO-OSV_wr_for_human_exp.txt.gz'" \
	--patience 30 \
	--epochs 1000 \
	--min_epochs 100 \
	...
	--study_kwargs.storage_kwargs.log_storage_kwargs.file_path "'./outputs/blorked_transitive_SVO-OSV_wr_for_human_exp/optuna_journal_storage.log'" \
	--study_kwargs.storage_kwargs.log_storage_kwargs.lock_obj optuna.storages.journal.JournalFileOpenLock \
	--study_kwargs.storage_kwargs.log_storage_kwargs.lock_obj_kwargs.filepath "'./outputs/blorked_transitive_SVO-OSV_wr_for_human_exp/optuna_journal_storage.log'" \
