...
#SBATCH --job-name=gpt2-blorked-bv
...
echo "Running script scripts/blorked_bv/gpt2-blorked-bv.sh"
echo ""
...
python core/finetune_lm.py \
	...
	--test_file "'data/syn_blorked_SVO-OSV_bv_for_human_exp/syn_blorked_SVO-OSV_bv_for_human_exp.txt.gz'" "'data/combined_fillers_for_human_exp/combined_fillers_for_human_exp.txt.gz'" \
	--patience 30 \
	--epochs 1000 \
	--min_epochs 100 \
