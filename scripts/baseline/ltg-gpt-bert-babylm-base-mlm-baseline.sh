...
#SBATCH --job-name=ltg-gpt-bert-babylm-base-mlm-baseline
...
echo "Running script scripts/crined_drink/ltg-gpt-bert-babylm-base-mlm-baseline.sh"
echo ""
...
python core/finetune_lm.py \
	...
	--output_dir outputs/baseline/ltg-gpt-bert-babylm-base-mlm